 ...
 */
export function useStore(store, log) {
    var _this = this;
    ...
    // original useReducer
    var _a = useReducer(reducer, state), _state = _a[0], _dispatch = _a[1];
 ...
 * @returns
 */
export function useToken(defaultValue) {
 ...
 * @returns {StoreHook<T>}
 */
export function useStoreProvider(provider$, initStore, log) {
    if (log === void 0) { log = false; }
